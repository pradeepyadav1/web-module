...
function EasyjQuery_Get_IP(fname,is_full) {
    Easy_IP_is_FULL = "IP_CLIENT_" + backcode;
    var json = EasyjQuery_getCookie(Easy_IP_is_FULL);

    if(json!=null) {
        EasyjQuery_Cache_IP(fname,jQuery.parseJSON(json));
    } else {
        jQuery.getScript("http://api.easyjquery.com/ips/?callback=" + fname);
    }

}

function EasyjQuery_Get_IP_SSL(fname,is_full) {
    Easy_IP_is_FULL = "IP_CLIENT_" + backcode;
    var json = EasyjQuery_getCookie(Easy_IP_is_FULL);
    ...
    if(json!=null) {
        ...
        jQuery.getScript("https://api.easyjquery.com/ips/?callback=" + fname);
    }

}


function EasyjQuery_Get_IP_Info(fname,IP) {
    var coo = "IP_" + MD5(IP);
    var json = EasyjQuery_getCookie(coo);
    if(json!=null) {
        EasyjQuery_Cache_IP_Info(fname,jQuery.parseJSON(json),coo);
    } else {
        jQuery.getScript("http://api.easyjquery.com/ips/?js_callback=EasyjQuery_Cache_IP_Info&ip=" + IP + "&callback=" + fname );
    }

}

function EasyjQuery_Get_IP_Info_SSL(fname,IP) {
    var coo = "IP_" + MD5(IP);
    var json = EasyjQuery_getCookie(coo);
    if(json!=null) {
        EasyjQuery_Cache_IP_Info(fname,jQuery.parseJSON(json),coo);
    } else {
        jQuery.getScript("https://api.easyjquery.com/ips/?js_callback=EasyjQuery_Cache_IP_Info&ip=" + IP + "&callback=" + fname );
    }
...
function EasyjQuery_Cache_IP_Info(fname,json,coo) {
    // console.log("_EasyjQuery_IP" + Easy_IP_is_FULL);
    if(typeof coo == "undefined") {
        coo = "IP_" + MD5(json.IP);
    }
    EasyjQuery_setCookie(coo,EasyjQuery_JSON_To_String(json),3);
    eval(fname + "(json);");
}
