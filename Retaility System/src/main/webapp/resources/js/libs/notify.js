...
var errorCss = ".alert{padding:8px 35px 8px 14px;margin-bottom:20px;text-shadow:0 1px 0 rgba(255, 255, 255, 0.5);background-color:#fcf8e3;border:1px solid #fbeed5;-webkit-border-radius:4px;-moz-border-radius:4px;border-radius:4px;}"
...
+" .alert { margin: 10px; display: inline-block; }"
...
$(function() {
  ...
  // hide message when user click on message
