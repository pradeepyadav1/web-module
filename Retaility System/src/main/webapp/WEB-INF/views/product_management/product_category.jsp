...
<body class="woodbg">
    ...
    <input type="hidden" id="_errorMsg_productCategoryNameRequired" value="<fmt:message key="product.validation.client.require.name" />" >
    <input type="hidden" id="_errorMsg_productCategoryNameExist" value="<fmt:message key="product.validation.client.require.brand" />" >
    <input type="hidden" id="_errorMsg_brandRequired" value="<fmt:message key="product.validation.client.require.name" />" >
